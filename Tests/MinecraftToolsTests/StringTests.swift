...
final class StringTests: XCTestCase {
    ...
    func testStringDeserialization() {
        let stream = DataStream(Data([0x00, 0x13, 0x53, 0x61, 0x6D, 0x70, 0x6C, 0x65, 0x20, 0x53, 0x74, 0x72, 0x69, 0x6E, 0x67, 0x20, 0x56, 0x61, 0x6C, 0x75, 0x65]))
    ...
    static var allTests = [
        ...
        ("testStringDeserialization", testStringDeserialization),
    ]
}
