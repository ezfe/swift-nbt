...
final class IntegerSerializationTests: XCTestCase {
    ...
    static var allTests = [
        ("testUInt8Serialization", testUInt8Serialization),
        ("testUInt16Serialization", testUInt16Serialization),
        ("testUInt32Serialization", testUInt32Serialization),
        ("testUInt64Serialization", testUInt64Serialization),
        ("testInt8Serialization", testInt8Serialization),
        ("testInt16Serialization", testInt16Serialization),
